...
\begin{abstract}
Natural language processing systems have revolutionized the way we interact with technology over the last several years, but these systems have yet to lower the barrier of entry to mathematics. In this study, we seek to create a translation system to link mathematical proofs constructed by users in everyday English with an automated proving system called Vampire. While the system is limited, it is functional within certain domains.
\end{abstract}
